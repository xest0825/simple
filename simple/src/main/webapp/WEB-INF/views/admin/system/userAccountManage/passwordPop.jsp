...
$(document).ready(function() {
	$('#form').ajaxForm({
		success : function(data) {
			...
			genexon.PopWindowClose2("change_account_pwd");
...
<div style="margin-top:20px; text-align:center; vertical-align:middle; width:85%; margin-left:auto; margin-right:auto;">
...
<div style="margin-top:10px; text-align:center; vertical-align:middle;">
	<div class="bt_glay2_S" id="bt_cancle">취소</div>
